          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex items-center justify-center md:justify-end gap-3 mb-3">
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-xs font-semibold text-white transition-all duration-200"
                style={{ background: "#FF0000", border: "1px solid rgba(255,255,255,0.15)" }}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                aria-label="YouTube"
              >
